...
import 'package:trendtalks/card_ui.dart';
...
class SavedPosts extends StatefulWidget {
  ...
  SavedPosts({super.key, required this.emailkey, required this.userdata});
  @override
  State createState() => _SavedPostsState();
}
...
class _SavedPostsState extends State<SavedPosts> {
  ...
  Future<void> getidlist() async {
    ...
    if (documentSnapshot.exists) {
      mypostid = List<String>.from(documentSnapshot.get("bookmark"));
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 83, 42, 5),
          elevation: 0,
        ),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              // if(demoPosts[index]["bookmark"]=="marked"){
                              //   demoPosts[index]["bookmark"] = "";
                              // }else {
                              //   demoPosts[index]["bookmark"] = "marked";
                              // }
                              setState(() {});
                            },
